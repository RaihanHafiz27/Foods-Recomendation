      ...
      <div className="w-full h-full flex justify-center items-center border border-green-400">
        <div className="w-full lg:w-3/5 h-full flex  justify-center items-center border border-red-500">
          <div className="w-full flex flex-col justify-center items-center">
            <h1 className=" flex flex-col text-center text-4xl md:text-6xl lg:text-7xl 2xl:text-8xl font-bold text-slate-200 tracking-widest">
              <span>Welcome </span> <span>to</span>
              <span className="text-amber-500">Mood Foods</span>
            </h1>
            <p className=" text-slate-200 my-4 text-sm md:text-base text-center w-4/5">
